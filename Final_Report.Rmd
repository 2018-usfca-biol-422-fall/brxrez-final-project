...
# generate a heat map to hopefully draw some inference of what can drive stress prevention and cardiac disease
gpac <- subset_taxa(melted_phyloseq, Class == "Actinobacteria")
plot_heatmap(gpac)
  
```

```{r filtered-ABCDG-treatment}
melted_phyloseq %>%
  filter(Subject %in% 
